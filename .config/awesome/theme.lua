...
theme.hotkeys_description_font                  = "mono 10"

theme.hotkeys_modifiers_fg                      = "#FF0000"

theme.bg_normal                                 = "#1e1e2e66"
...
-- Icons
theme.awesome_icon                              = config_path .. "assets/icon.svg"
theme.power_icon                                = config_path .. "assets/power.svg"
